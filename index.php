...
<body>
	<div id="container">
		...
		<ul class="logo">
			<li><object class="layer" type="image/svg+xml" data="img/logo/logoColor.svg#yellow"></object></li>
			<li><object class="layer" type="image/svg+xml" data="img/logo/logoColor.svg#red"></object></li>
			<li><object class="layer" type="image/svg+xml" data="img/logo/logoColor.svg#green"></object></li>
		</ul>
		<div class="grid projectTitle">

		</div>
		<div id="imageGalleryWrapper">
			<p id="welcomeText"><span> Recent: The Wurlitzer </span></p>
			<ul class="recentProject">
				<li>
					<section>
						<a href="Wurlitzer.php">
							<img sizes="100vw, (min-width: 40em) 80vw" srcset="img/project/recent/theWurlitzer-prev.png 280w, 
							img/project/recent/theWurlitzer-prev.png 600w, img/project/recent/theWurlitzer-prev.png 1200w" alt="Why are You Watching?!">
						</a>
					</section>
				</li>
			</ul>
			<ul class="grid">
				...
				<li>
					<section>
						<a href="whyAreYouWatching.php">
							...
							<figcaption class="projectCaption">
								<h2>Why Are You Watching?!</h2>
								<br>
				...
				<li>
					<section>
						<a href="#">
							<figure class="stack stack-previewgrid">
								<img sizes="100vw, (min-width: 40em) 80vw" srcset="img/projectPreview/Q110/Q110-1s.png 280w, 
								img/projectPreview/Q110/Q110-1m.png 600w, img/projectPreview/Q110/Q110-1.png 1200w" alt="Q110">
								<img sizes="100vw, (min-width: 40em) 80vw" srcset="img/projectPreview/Q110/Q110-2s.png 280w, 
								img/projectPreview/Q110/Q110-2m.png 600w, img/projectPreview/Q110/Q110-2.png 1200w" alt="Q110">
								<img sizes="100vw, (min-width: 40em) 80vw" srcset="img/projectPreview/Q110/Q110-3s.png 280w, 
								img/projectPreview/Q110/Q110-3m.png 600w, img/projectPreview/Q110/Q110-3.png 1200w" alt="Q110">
								<img sizes="100vw, (min-width: 40em) 80vw" srcset="img/projectPreview/Q110/Q110-4s.png 280w, 
								img/projectPreview/Q110/Q110-4m.png 600w, img/projectPreview/Q110/Q110-4.png 1200w" alt="Q110">
							</figure>
							<figcaption class="projectCaption">
								<h2>Q110</h2>
								<br>
